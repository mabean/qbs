...
Module {
    ...
    Properties {
        condition: _enableRules && codesign.enablePackageSigning
        codesign.packageName: product.Android.sdk.apkBaseName + (_generateAab ? ".aab" : ".apk")
    ...
    Rule {
        ...
        Artifact {
            filePath: product.Android.sdk.apkBaseName + (
                      product.codesign.enablePackageSigning ? ".apk_unsigned" : ".apk")
            fileTags: product.codesign.enablePackageSigning ? "android.package_unsigned" :
                                                              "android.package"
        }
    ...
    Rule {
        ...
        Artifact {
            filePath: product.Android.sdk.apkBaseName + (
                      product.codesign.enablePackageSigning ? ".aab_unsigned" : ".aab")
            fileTags: product.codesign.enablePackageSigning ? "android.package_unsigned" :
                                                              "android.package"
        }
